...
var bgMusic = null;
var gameOverDialogue = null;
window.addEventListener("load", function () {
  bgMusic = document.getElementById("bg-music");
  gameOverDialogue = document.getElementById("gameover-dialogue");

  bgMusic.volume = 0.35;
  gameOverDialogue.volume = 1.0;
});
(function () {
  "use strict";
  /**
    ...
    update: function () {
      ...
      if (this.playing) {
        ...
        if (!collision) {
          ...
          if (gameOverDialogue) {
            gameOverDialogue.currentTime = 0;
            gameOverDialogue.play().catch(function () {});
          }
    ...
    (Obstacle.prototype = {
      ...
      draw: function () {
        ...
        if (this.typeConfig.type === "PTERODACTYL") {
          var batSprite = document.getElementById("bat-sprite");

          // Bat sprite sheet = 64x32
          // Frame 1 = left 32x32
          // Frame 2 = right 32x32
          var frameSize = 32;
        ...
        // ============================================================
        // CUSTOM CACTUS / GROUND OBSTACLES
        // ============================================================
        if (
          this.typeConfig.type === "CACTUS_LARGE" ||
          this.typeConfig.type === "CACTUS_SMALL"
        ) {
          var obstaclesSprite = document.getElementById("obstacles-sprite");

          // Your PNG:
          // 1100 x 1479
          // LEFT  = large cactus
          // RIGHT = small cactus
          var sourceX = this.typeConfig.type === "CACTUS_LARGE" ? 0 : 550;

          var sourceWidth = 550;
          var sourceHeight = 1479;

          // Draw every cactus separately.
          for (var i = 0; i < this.size; i++) {
            this.canvasCtx.drawImage(
              ...
              // DESTINATION
              this.xPos + i * this.typeConfig.width,
              this.yPos,
              this.typeConfig.width,
              this.typeConfig.height,
            );
        ...
        // ============================================================
        // ORIGINAL CHROME OBSTACLE DRAWING
        // ============================================================
  ...
  function Trex(canvas, spritePos) {
    ...
    // Our runner is made from two separate PNGs instead of the original
    // Chrome Dino sprite-sheet.
    this.runnerImages = [
      document.getElementById("runner-frame-1"),
      document.getElementById("runner-frame-2"),
    ];
   ...
   */
  Trex.collisionBoxes = {
    DUCKING: [new CollisionBox(3, 4, 34, 48)],
    RUNNING: [new CollisionBox(3, 4, 34, 48)],
  };
  ...
  Trex.prototype = {
     ...
     * @param {number} y
     */
    draw: function (frameIndex, y) {
      var runnerImage = this.runnerImages[frameIndex] || this.runnerImages[0];

      // Draw our PNG at the same logical size on every frame so the
      // character does not jump around while the images alternate.
